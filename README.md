...
2. **Least Square (UTide)** - Menggunakan library UTide (OLS fitting)
3. **Least Square (NumPy)** - Menggunakan `numpy.linalg.lstsq` (baru!)
...
1. Pilih metode analisis:
   - **HARMONIC LEAST SQUARE (UTide)** → method='ols'
